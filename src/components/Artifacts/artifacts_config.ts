...
import { shadcnComponents } from '../Artifacts/shared_shadcn_components';
import type {
...
/**
 * Supported artifact modes for code preview
 */
...
/**
 * Supported artifact types for code preview
 */
...
/**
 * Determines the artifact mode based on configuration options
 */
export const getArtifactsMode = ({
  ...
  if (!codeArtifacts) return undefined;
  if (customPromptMode) return ArtifactModes.CUSTOM;
  if (includeShadcnui) return ArtifactModes.SHADCNUI;
  return ArtifactModes.DEFAULT;
};

/**
 * Mapping of artifact types to their corresponding filenames
 */
...
/**
 * Mapping of artifact types to their corresponding Sandpack templates
 */
...
/**
 * Gets the file extension based on the language
 */
export function getFileExtension(language?: string): string {
  switch (language) {
    case 'application/vnd.react': return 'tsx';
    case 'application/vnd.mermaid': return 'mermaid';
...
/**
 * Generates a unique key for artifact type and language combination
 */
export function getKey(type: string, language?: string): string {
  return `${type}-${language || 'unknown'}`;
}

/**
 * Gets the appropriate filename for the artifact type and language
 */
...
/**
 * Gets the appropriate Sandpack template for the artifact type and language
 */
...
/**
 * Standard dependencies for all artifacts
 */
...
/**
 * Additional dependencies for Mermaid diagrams
 */
...
/**
 * Mapping of artifact types to their required dependencies
 */
...
/**
 * Gets the dependencies for a specific artifact type
 */
...
/**
 * Gets the Sandpack provider props for a specific artifact type
 */
...
/**
 * Shared Sandpack options for all artifacts
 */
...
/**
 * Shared files available to all Sandpack instances
 */
